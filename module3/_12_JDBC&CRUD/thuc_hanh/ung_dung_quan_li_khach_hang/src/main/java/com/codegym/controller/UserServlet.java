...
import com.codegym.model.service.UserServiceImpl;
...
//    private void sortUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
//        String country = request.getParameter("country");
//
//        List<User> listUser =  userService.sort("name");
...
//    }
    ...
    private void searchUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        List<User> listUser =  userService.find(country);
        request.setAttribute("listUser", listUser);
